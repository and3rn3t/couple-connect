...
export const LazyPhosphorIcons = {
  ...
  CheckCircle: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.CheckCircle }))),
  ...
  ArrowClockwise: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.ArrowClockwise }))),
  WifiSlash: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.WifiSlash }))),
  CloudArrowUp: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.CloudArrowUp }))),
  ...
  PencilSimple: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.PencilSimple }))),
  MagnifyingGlass: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.MagnifyingGlass }))),
  ...
  GameController: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.GameController }))),
  ...
  HandsClapping: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.HandsClapping }))),
  ...
  Certificate: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.Certificate }))),
  ...
  Beach: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.Beach }))),
  ...
  FlowerLotus: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.FlowerLotus }))),
  ...
  Thermometer: lazy(() => import('@phosphor-icons/react').then(m => ({ default: m.Thermometer }))),
};
...
export const Beach = withLazyIcon(LazyPhosphorIcons.Beach, 16);
