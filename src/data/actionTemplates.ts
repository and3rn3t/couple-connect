...
export const actionTemplates: ActionTemplate[] = [
  // Communication Templates
  {
    ...
    description: 'Set aside 15 minutes each evening to share how your day went, discuss any concerns, and plan for tomorrow together.',
  ...
  },
  {
    ...
    description: 'Take turns speaking for 5 minutes while the other person listens without interrupting, then summarize what you heard.',
    suggestedAssignment: 'both',
  ...
  },
  {
    ...
    description: 'Together, create a set of rules for how you\'ll handle disagreements (no yelling, taking breaks when heated, etc.).',
    suggestedAssignment: 'both',
    suggestedDuration: 3,
  ...
  },
  {
    ...
    description: 'Hold a weekly 30-minute meeting to discuss relationship goals, address concerns, and celebrate wins.',
    suggestedAssignment: 'both',
  ...
  // Intimacy Templates
  {
    ...
    description: 'Take turns planning a special date night each week, focusing on quality time together without distractions.',
    suggestedAssignment: 'both',
  ...
  },
  {
    ...
    description: 'Make an effort to include more hugs, kisses, and non-sexual touch throughout each day.',
    suggestedAssignment: 'both',
    suggestedDuration: 14,
  ...
  },
  {
    ...
    description: 'Identify your partner\'s primary love language and consciously express love in that way daily.',
    suggestedAssignment: 'both',
    suggestedDuration: 21,
  ...
  },
  {
    ...
    description: 'Schedule a comfortable, private time to openly discuss your intimacy needs, desires, and boundaries.',
    suggestedAssignment: 'both',
    suggestedDuration: 1,
  ...
  // Finance Templates
  {
    ...
    description: 'Meet monthly to review expenses, discuss financial goals, and adjust your budget as needed.',
    suggestedAssignment: 'both',
  ...
  },
  {
    ...
    description: 'Agree on a spending limit that requires discussion with your partner before making purchases.',
    suggestedAssignment: 'both',
    suggestedDuration: 14,
  ...
  },
  {
    ...
    description: 'Together, identify 3 financial goals (short, medium, long-term) and create action plans to achieve them.',
    suggestedAssignment: 'both',
    suggestedDuration: 7,
  ...
  },
  {
    ...
    description: 'Both partners track every expense to get a clear picture of spending patterns and identify areas for improvement.',
    suggestedAssignment: 'both',
    suggestedDuration: 14,
  ...
  // Time Management Templates
  {
    ...
    description: 'Block out specific times each week that are dedicated solely to being together without work or other distractions.',
    suggestedAssignment: 'both',
    suggestedDuration: 21,
  ...
  },
  {
    ...
    description: 'Set up a shared digital calendar to coordinate schedules, plan together time, and avoid conflicts.',
    suggestedAssignment: 'both',
    suggestedDuration: 3,
  ...
  },
  {
    ...
    description: 'Agree on specific times (meals, first hour home, etc.) when phones and devices are put away.',
    suggestedAssignment: 'both',
    suggestedDuration: 14,
  ...
  },
  {
    ...
    description: 'Discuss and schedule regular individual time for personal hobbies, friends, and self-care.',
    suggestedAssignment: 'both',
    suggestedDuration: 14,
  ...
  // Family Templates
  {
    ...
    description: 'Hold regular family meetings to discuss schedules, address issues, and make decisions together.',
    suggestedAssignment: 'both',
    suggestedDuration: 28,
  ...
  },
  {
    ...
    description: 'Discuss and agree on consistent parenting approaches, discipline methods, and household rules.',
    suggestedAssignment: 'both',
    suggestedDuration: 7,
  ...
  },
  {
    ...
    description: 'Discuss and establish boundaries with extended family regarding holidays, visits, and involvement in decisions.',
    suggestedAssignment: 'both',
    suggestedDuration: 7,
  ...
  // Personal Growth Templates
  {
    ...
    description: 'Share individual goals with each other and create specific ways to support and encourage progress.',
    suggestedAssignment: 'both',
    suggestedDuration: 21,
  ...
  },
  {
    ...
    description: 'Each evening, share three things you\'re grateful for, including at least one thing about your partner.',
    suggestedAssignment: 'both',
    suggestedDuration: 21,
  ...
  },
  {
    ...
    description: 'Commit to attending couples counseling sessions to work on your relationship with professional guidance.',
    suggestedAssignment: 'both',
